...
import 'package:udemy_flutter/layout/shop_app/categories/categories_screen.dart';
import 'package:udemy_flutter/layout/shop_app/cubit/states.dart';
import 'package:udemy_flutter/layout/shop_app/favorites/favorites_screen.dart';
import 'package:udemy_flutter/layout/shop_app/products/products_screen.dart';
import 'package:udemy_flutter/layout/shop_app/settings/settings_screen.dart';
...
class ShopCubit extends Cubit<ShopStates> {
  ...
  void getHomeData() {
    ...
    DioHelper.getData(url: HOME, token: token).then((value) {
      ...
      //printFullText(homeModel.data.banners[0].toString());
